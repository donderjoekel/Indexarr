...
namespace NzbDrone.Core.Update
{
    public class InstallUpdateService : IExecute<ApplicationCheckUpdateCommand>, IExecute<ApplicationUpdateCommand>, IHandle<ApplicationStartingEvent>
    {
        ...
        private bool InstallUpdate(UpdatePackage updatePackage)
        {
            ...
            {
                _logger.Warn("Temporary location '{0}' has less than 1 GB free space, Indexarr may not be able to update itself.", tempFolder);
            }
            ...
            _logger.ProgressInfo("Indexarr will restart shortly.");
        ...
        private void InstallUpdateWithScript(string updateSandboxFolder)
        {
            ...
            _logger.Info("Removing Indexarr.Update");
        ...
        private void EnsureAppDataSafety()
        {
            ...
            {
                throw new UpdateFailedException("Your Indexarr configuration '{0}' is being stored in application folder '{1}' which will cause data lost during the upgrade. Please remove any symlinks or redirects before trying again.", _appFolderInfo.AppDataFolder, _appFolderInfo.StartUpFolder);
            }
        }
        ...
        public void Execute(ApplicationUpdateCommand message)
        {
            ...
            if (latestAvailable != null)
            {
                try
                {
                    ...
                    _logger.ProgressDebug("Restarting Indexarr to apply updates");
                }
