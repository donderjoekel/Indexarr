    ...
    public static class ConsoleApp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + " This can happen if another instance of Indexarr is already running another application is using the same port (default: 9696) or the user has insufficient permissions");
